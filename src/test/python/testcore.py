...
class CoreTest(SmvBaseTest):
    ...
    def test_normalizeDf(self):
        ...
        exp = self.createDF("PMID: String;Journal_ISSN: String;Article_Title: String;Journal_Title: String;Journal_Publish_Date: String;Journal_Country: String;Grant_Ids: String;Mesh_Headings: String;Chemicals: String;Affiliation: String;Author_Identifier: String;LastName: String;ForeName: String;_ValidYN: String;Initials: String",
            ...
            9103774_1,Print_0882-5963,Parenting attitudes and behaviors of low-income single mothers with young children.,Journal of pediatric nursing,1997-04-01,UNITED STATES,R01 NR1960-03,D000328|D001290|D002648|D002675|D005260|D006801|D007223|D007407|D009034|D009035|D016487|D011203|D015406|D012959,,,,Hall,L A,Y,LA""")
